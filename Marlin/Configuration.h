...
#define STRING_CONFIG_H_AUTHOR "(NeoAcheron, QQ-S config)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 288.12        // (mm) Custom Haydn Huntley Magnaball arms

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 324.00             // (mm) Get this value from G33 auto calibrate (-48mm from stock with Duet32 Smart effector and Mosquito hotend)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 300, 120 }
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 4000, 4000, 4000, 5000 } // ...or, set your own edit limits
#endif
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 15, 15, 15, 20 } // ...or, set your own edit limits
  #endif
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 120, 20 }
